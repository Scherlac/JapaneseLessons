...
- `jlesson.lesson_pipeline`: `17` [...](../jlesson/lesson_pipeline/__init__.py#L1)
- `jlesson.lesson_pipeline.pipeline_orchestrator`: `9` [...](../jlesson/lesson_pipeline/pipeline_orchestrator.py#L1)
- `jlesson.lesson_pipeline.save_report`: `6` [...](../jlesson/lesson_pipeline/save_report.py#L1)
- `jlesson.cli`: `6` [...](../jlesson/cli.py#L1)
- `jlesson.asset_compiler`: `6` [...](../jlesson/asset_compiler.py#L1)
...
- `jlesson.lesson_pipeline.persist_content`: `4` [...](../jlesson/lesson_pipeline/persist_content.py#L1)
...
- `jlesson.lesson_pipeline.pipeline_core`: `15` [...](../jlesson/lesson_pipeline/pipeline_core.py#L1)
- `jlesson.lesson_pipeline.pipeline_gadgets`: `13` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L1)
- `jlesson.curriculum`: `6` [...](../jlesson/curriculum.py#L1)
- `jlesson.language_config`: `6` [...](../jlesson/language_config.py#L1)
- `jlesson.profiles`: `6` [...](../jlesson/profiles.py#L1)
- `jlesson.touch_compiler`: `3` [...](../jlesson/touch_compiler.py#L1)
- `jlesson.lesson_pipeline`: `3` [...](../jlesson/lesson_pipeline/__init__.py#L1)
- `jlesson.llm_client`: `3` [...](../jlesson/llm_client.py#L1)
- `jlesson.prompt_template`: `3` [...](../jlesson/prompt_template.py#L1)

## Cross-Group Dependencies

- `asset_compiler` -> `video` (2), `language_config` (1), `lesson_pipeline` (1), `models` (1), `profiles` (1)
- `cli` -> `curriculum` (1), `vocab_generator` (1), `language_config` (1), `config` (1), `prompt_template` (1), `lesson_pipeline` (1)
- `curriculum` -> `models` (1)
- `item_generator` -> `models` (1)
- `language_config` -> `curriculum` (1), `video` (1), `item_generator` (1), `prompt_template` (1), `models` (1)
- `lesson_pipeline` -> `models` (9), `profiles` (4), `curriculum` (4), `language_config` (3), `touch_compiler` (3), `retrieval` (2), `lesson_report` (2), `lesson_store` (2), `video` (2), `asset_compiler` (2), `vocab_generator` (1), `llm_cache` (1), `llm_client` (1)
...
- `video` -> `lesson_pipeline` (1), `models` (1), `language_config` (1)
- `vocab_generator` -> `prompt_template` (1), `llm_client` (1)

## Cycles

- `jlesson.asset_compiler` -> `jlesson.lesson_pipeline` -> `jlesson.lesson_pipeline.compile_assets` -> `jlesson.lesson_pipeline.pipeline_orchestrator` -> `jlesson.video.cards` [...](../jlesson/asset_compiler.py#L21)
