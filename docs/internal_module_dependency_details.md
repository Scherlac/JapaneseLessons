...
- `jlesson.lesson_pipeline.pipeline_gadgets` -> `jlesson.lesson_pipeline.pipeline_paths` -> `jlesson.language_config` -> `jlesson.curriculum` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L9)
- `jlesson.lesson_pipeline.pipeline_gadgets` -> `jlesson.lesson_pipeline.pipeline_paths` -> `jlesson.language_config` -> `jlesson.prompt_template` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L9)
- `jlesson.lesson_pipeline.pipeline_gadgets` -> `jlesson.lesson_pipeline.pipeline_llm` -> `jlesson.llm_client` -> `jlesson.config` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L8)

### `jlesson.lesson_pipeline.compile_assets` [...](../jlesson/lesson_pipeline/compile_assets.py#L1)

- `jlesson.lesson_pipeline.compile_assets` -> `jlesson.asset_compiler` -> `jlesson.language_config` -> `jlesson.curriculum` [...](../jlesson/lesson_pipeline/compile_assets.py#L3)
- `jlesson.lesson_pipeline.compile_assets` -> `jlesson.asset_compiler` -> `jlesson.language_config` -> `jlesson.prompt_template` [...](../jlesson/lesson_pipeline/compile_assets.py#L3)
- `jlesson.lesson_pipeline.compile_assets` -> `jlesson.asset_compiler` -> `jlesson.language_config` -> `jlesson.item_generator` [...](../jlesson/lesson_pipeline/compile_assets.py#L3)
...
- `jlesson.lesson_pipeline.pipeline_grammar` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L7)
- `jlesson.lesson_pipeline.pipeline_llm` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L8)
- `jlesson.lesson_pipeline.pipeline_paths` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L9)
- `jlesson.lesson_pipeline.pipeline_vocab` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L10)
- `jlesson.models` [...](../jlesson/lesson_pipeline/pipeline_gadgets.py#L5)
